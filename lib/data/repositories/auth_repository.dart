...
class AuthRepository
{
    ...
    Future<void> tryAutoLogin() async
    {
        ...
        try
        {
            ...
            {
                print('AuthRepository: Token validation failed. Status: ${response.statusCode}');
                await logout();
            }
        }
        catch (e)
    ...
    Future<UserProfile> fetchUserProfileById(String userId) async
    {
        ...
        try
        {
            ...
            {
                throw Exception('Failed to fetch user profile for ID $userId. Status: ${response.statusCode}');
            }
        }
        on DioException catch (e)
        {
    ...
    Future<List<UserProfile>> fetchAllUsers() async
    {
        ...
        try
        {
            ...
            {
                throw Exception('Failed to fetch all users. Status code: ${response.statusCode}');
            }
        }
        on DioException catch (e)
        {
